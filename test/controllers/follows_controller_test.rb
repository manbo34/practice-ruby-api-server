...
class FollowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follow" do
    assert_difference('Follow.count') do
      post follows_url, params: { follow: { follow_id: @follow.follow_id, user_id: @follow.user_id } }, as: :json
    end
  ...
  test "should update follow" do
    patch follow_url(@follow), params: { follow: { follow_id: @follow.follow_id, user_id: @follow.user_id } }, as: :json
    assert_response 200
  end
